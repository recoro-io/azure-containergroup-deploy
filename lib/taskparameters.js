...
class TaskParameters {
    constructor(endpoint) {
        ...
        let received_ports = core.getInput('ports');
        console.log('Received port input: ', received_ports, "type: ", typeof(received_ports));
        if (!!received_ports && typeof(received_ports === 'string')) {
           this._ports = this._getPorts(received_ports);
        } else {
            this._ports = this._getPorts("80:TCP");
        }
        console.log('Computed ports: ', this._ports, "type: ", typeof(this._ports));
        this._subnetIds = core.getInput('subnetIds');
        console.log('Got subnetIds: ', this.subnetIds);
    }
