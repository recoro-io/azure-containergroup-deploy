...
const containerInstanceManagementClient_1 = require("./arm-containerinstance/containerInstanceManagementClient");
...
function main() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const client = new containerInstanceManagementClient_1.ContainerInstanceManagementClient(creds, taskParams.subscriptionId);
