...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log('Computed ports in task params: ', taskParams.ports, "type: ", typeof(taskParams.ports));
            ...
            let containerDeploymentResult = yield client.containerGroups.createOrUpdate(taskParams.resourceGroup, taskParams.groupName, containerGroupInstance);
...
function getGroupPorts(taskParams) {
    return taskParams.containers.reduce((portsList, nextContainer) => {
        if (!!nextContainer.ports) {
            const containerPortList = nextContainer.ports.map(containerPort => (Object.assign({}, containerPort)));
